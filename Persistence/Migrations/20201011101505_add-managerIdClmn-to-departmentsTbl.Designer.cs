...
namespace Persistence.Migrations
{
    ...
    [Migration("20201011101505_add-managerIdClmn-to-departmentsTbl")]
    partial class addmanagerIdClmntodepartmentsTbl
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.LeaveRequest", b =>
                {
                    ...
                    b.ToTable("t_leaveRequest");

                    b.HasCheckConstraint("CK_t_leaveRequest_Status_Enum_Constraint", "[Status] IN(0, 1, 2)");
                });

            modelBuilder.Entity("Domain.Leaves", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.EmployeeDetails", b =>
                {
                    ...
                    b.HasOne("Domain.LeaveRequest", null)
                        .WithMany("Employee")
            ...
            modelBuilder.Entity("Domain.LeaveRequest", b =>
                {
                    b.HasOne("Domain.EmployeeDetails", "SentTo")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Leaves", b =>
                {
                    b.HasOne("Domain.EmployeeDetails", "Employee")
                        .WithOne("Leaves")
                        .HasForeignKey("Domain.Leaves", "EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
