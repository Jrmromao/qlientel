...
{
    public class IsEmployee : IAuthorizationRequirement
    {
    }

    public class IsEmployeeHandler : AuthorizationHandler<IsAdmin>
    {
        private readonly IHttpContextAccessor _accessor;
        private readonly DataContext _context;
        private readonly UserManager<AppUser> _userManager;

        public IsEmployeeHandler(IHttpContextAccessor accessor, DataContext context, UserManager<AppUser> userManager)
        {
            _accessor = accessor;
            _context = context;
        ...
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, IsAdmin requirement)
        {
            ...
            if (string.IsNullOrEmpty(role.Name) || role.Name != "User")
